class Ingredients::UsersHasIngredientsController < ApplicationController
 # before_action :set_users_has_ingredient, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    @users_has_ingredient.ingredient = @ingredient
    respond_to do |format|
      if @users_has_ingredient.save
        format.html { redirect_to @ingredient, notice: 'Users has ingredient was successfully created.' }
