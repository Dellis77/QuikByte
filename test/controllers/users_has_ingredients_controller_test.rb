...
class UsersHasIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create users_has_ingredient" do
    assert_difference('UsersHasIngredient.count') do
      post users_has_ingredients_url, params: { users_has_ingredient: { ingredients_id: @users_has_ingredient.ingredients_id, users_id: @users_has_ingredient.users_id } }
    end
  ...
  test "should update users_has_ingredient" do
    patch users_has_ingredient_url(@users_has_ingredient), params: { users_has_ingredient: { ingredients_id: @users_has_ingredient.ingredients_id, users_id: @users_has_ingredient.users_id } }
