...
class RecipesHasIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipes_has_ingredient" do
    assert_difference('RecipesHasIngredient.count') do
      post recipes_has_ingredients_url, params: { recipes_has_ingredient: { ingredient_id: @recipes_has_ingredient.ingredient_id, recipe_id: @recipes_has_ingredient.recipe_id } }
    end
  ...
  test "should update recipes_has_ingredient" do
    patch recipes_has_ingredient_url(@recipes_has_ingredient), params: { recipes_has_ingredient: { ingredient_id: @recipes_has_ingredient.ingredient_id, recipe_id: @recipes_has_ingredient.recipe_id } }
